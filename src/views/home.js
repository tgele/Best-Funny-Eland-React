          ...
          <div className="products-grid">
            <div className="product-card">
              <div className="product-image-wrapper">
                <img
                  ...
                  src="https://images.pexels.com/photos/11279905/pexels-photo-11279905.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
            ...
            <div className="product-card">
              <div className="product-image-wrapper">
                <img
                  ...
                  src="https://images.pexels.com/photos/9246017/pexels-photo-9246017.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                  className="product-img"
                />
              </div>
              <div className="product-info">
            ...
            <div className="product-card">
              <div className="product-image-wrapper">
                <img
                  alt="Draeger PAPR"
                  src="https://images.pexels.com/photos/9894216/pexels-photo-9894216.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                  className="product-img"
                />
              </div>
              <div className="product-info">
                <h3 className="section-subtitle">動力式呼吸防護系統 (PAPR)</h3>
                <p className="section-content">
            ...
            <div className="product-card">
              <div className="product-image-wrapper">
                <img
                  alt="Draeger SCBA"
                  src="https://images.pexels.com/photos/7932921/pexels-photo-7932921.jpeg?auto=compress&amp;cs=tinysrgb&amp;w=1500"
                  className="product-img"
                />
              </div>
              <div className="product-info">
